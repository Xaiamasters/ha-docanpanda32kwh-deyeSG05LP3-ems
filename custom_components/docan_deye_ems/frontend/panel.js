...
class DocanDeyeEMSPanel extends HTMLElement {
 ...
 render(){
  ...
  this.text('plan-mode',plan.mode==='production_shadow'?'PRODUCTION POLICY · SHADOW':plan.mode==='observed'?'OBSERVED CONTROLLER PLAN · READ ONLY':plan.mode==='forecast_shadow'?'FORECAST SIMULATION · NOT ARMED':'SHADOW ESTIMATE · NOT ARMED');
